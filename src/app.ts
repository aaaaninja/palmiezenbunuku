...
////////////////////////////////////////////////////////////////////////////////
  ...
  const course_kind: 'daily_lesson_chapters' | 'prime_lessons' = target_chapter_url.match(/https:\/\/www.palmie.jp\/(.+)\//)?.[1]
  // 'https://www.palmie.jp/prime_lessons/657'.match(/https:\/\/www.palmie.jp\/(.+)\//)[1]
  // => "prime_lessons"
